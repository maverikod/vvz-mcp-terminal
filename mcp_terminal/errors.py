...
class ErrorCode:
    ...
    HOST_KEY_ACCESS_FORBIDDEN: str = "HOST_KEY_ACCESS_FORBIDDEN"
    TARGET_USER_NOT_ALLOWED: str = "TARGET_USER_NOT_ALLOWED"
    HOST_SSH_UNREACHABLE: str = "HOST_SSH_UNREACHABLE"
    HOST_HOST_KEY_MISMATCH: str = "HOST_HOST_KEY_MISMATCH"
    PURGE_SESSIONS_DISABLED: str = "PURGE_SESSIONS_DISABLED"
    CLIENT_SESSION_NOT_FOUND: str = "CLIENT_SESSION_NOT_FOUND"
    SUBORDINATE_SESSION_NOT_LINKED: str = "SUBORDINATE_SESSION_NOT_LINKED"
    CODE_ANALYSIS_UNAVAILABLE: str = "CODE_ANALYSIS_UNAVAILABLE"
